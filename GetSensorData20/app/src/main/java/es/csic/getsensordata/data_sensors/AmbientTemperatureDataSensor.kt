...
class AmbientTemperatureDataSensor(private val context: Context): DataSensor(context, Sensor.TYPE_AMBIENT_TEMPERATURE) {
    override fun getSensorPrefix(): String =
        context.getString(R.string.ambient_temperature_sensor_prefix)
